        ...
        <div className="col-md-6 col-12 mx-auto m-2">
            <div className="card">
                <div className="card-body ">
                    ...
                    <div className="px-3">
                        <a href="https://github.com/HollyPurvis/Website-Portfolio" target="_blank">Github</a>
        ...
        <div className="col-md-6 col-12 mx-auto m-2">
            <div className="card">
                <div className="card-body ">
                    ...
                    <p><a href="https://github.com/HollyPurvis/Website-Portfolio" target="_blank">Github</a> | <a href="https://hollypurvis.github.io/travel-checklist/" target="_blank">https://hollypurvis.github.io/travel-checklist/</a></p>

                    
                    <p>Skills: HTML, CSS, JavaScript, Bootstrap, GitHub, and incorporates a REST API</p>
